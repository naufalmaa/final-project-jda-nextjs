...
*/
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'SCHOOL_ADMIN', 'SUPERADMIN');
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_assignedSchoolId_fkey" FOREIGN KEY ("assignedSchoolId") REFERENCES "School"("id") ON DELETE SET NULL ON UPDATE CASCADE;
